    ...
    return (
        <Section id="pavolhejny">
            ...
            <div className={styles.about}>
                ...
                <p>
                    At the same time, he participated in many events and startup competitions as a{' '}
                    <strong>mentor</strong> and a <strong>jury</strong>.
                </p>
                <p>
                ...
                <p>
                    He has an overview of what is happening in the Czech Republic for IT &amp; startup events. That’s
                    why he is sending out a regular monthly email about the most exciting events at{' '}
