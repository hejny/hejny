...
**Here are his posts, profile, talks and texts from the recent time:**
...
Přednáška je určena pro všechny, kteří si lámou hlavu nad tím, zda a jakým způsobem mají AI nasazovat. A to ať už pro majitele firem, produkťáky, nebo i samotné vývojáře.

Zároveň přednášku pojmu trochu netradičním způsobem a mým spoluřečníkem bude můj AI agent.
```
...
Za poslední rok se tohle slovo stalo všudypřítomné. Někteří jsou iritováni záplavou slop-code, jiní fascinováni, jak dobře dokáže AI programovat.



My jsme v naší firmě za poslední dva měsíce vyvinuli víc hodnotných features, než za poslední dva roky.

A to jsme nenapsali téměř řádek kódu.



Ukážu vám konkrétní techniky, pomocí kterých dokážete AI coding využít naplno a neohrozit produkci.

Budu mluvit o managementu PRDs, GITu, automatickém testování, CI/CD, pravidlech pro agenty, code-reviews, prioritizaci požadavků a dalších věcech.

Komu je přednáška určena?
Vývojářům, majitelům, firem, tech-leadům, product ownerům,... všem, kteří by rádi AI využívali naplno ve svém vývoji.
...
Promptbook
O přednášejícím
Jsem Pavol, vývojář s více než 15letou každodenní zkušeností s vývojem aplikací.
V současnosti pomáhám firmám se spuštěním jejich vlastního AI.

Kde se přednáška koná?
Přednáška se koná od 14:00 v místnosti Horní

Podívej se na celý program
```

```text
AI ve ve firmách a organizacích
O přednášce
V praxi se často setkávám se 2mi extrémy "Před 3mi lety jsme udělali školení na ChatGPT, takže AI máme hotové" vs. "Už jsme vyhodili polovinu programátorů a účetní oddělení, protože je přece nahradí AI."

Realita však bývá složitější a paradoxně často není o samotných AI modelech a nástrojích, ale o všem okolo.

Budu mluvit o tom, jakým způsobem se dívat na ochranu dat, spolehlivost a kontrolu kvality vašich výstupů.

Management oprávnění ve firmě. Jak vůbec si takové nástroje vybírat? Jakým způsobem nahrazovat a automatizovat lidskou práci? Zda si tvořit svoji knowledgebase a kontext, ochrana dat, rulesety....

Komu je přednáška určena?
Majitelům firem nebo stakeholderům ve firmách, tajemníkům, starostům, ředitelům škol, lidem ve vedeních, kteří (ne)chtějí zavádět AI.
...
```text
Myslím, že (AI) vendor-lock je něco, na co často zapomínáme.
Platilo to pro OpenAI GPTs, platí to pro Anthropic agenty, obzvlášť pokud je používám na něco kritického.
Zároveň v tomhle OpenClaw není úplně dobrou alternativou, sice open source, ale má tisíc jiných problémů, pro které by asi neměl být použitý pro jakoukoliv serióznější práci.
Každopádně bych byl trochu opatrný s tím nekrologem. Myslím, že AI svět se pohybuje tak strašně rychle dopředu, že co se dneska jeví jako definitivní, může být zítra úplně, ale úplně jinak.
Ještě před dvěma lety to v principu vypadalo, že tuhle hru OpenAI absolutně drtivě vyhrálo.
A dneska?
Navíc Anthropic není Apple.
```

```text
Stále víc si říkám, že nad AI codingem / Vibe-codingem je potřeba mít nějaký alespoň trochu standardizovaný proces.
Teď nemyslím to, udělat jedno školení a každému člověku koupit Claude Code nebo GitHub Copilot, ale mít nastavené konkrétní procesy, quality checky, sjednocený context management, agenty, automatizace backlogu,...
A také vyhodnocovat, zda je využitý čas lidí a tokeny agentů efektivně...
A stává se z toho kontinuální proces na kterém my děláme
```

```text
Právě jsme volali s investorem. Todo: pošlete nám pitch deck.
Jenže udržovat pitch deck aktuální je častokrát práce navíc - a  kdo má na to čas? My to vyřešili jinak. Máme Promptbook  agenta, který na pozadí sleduje náš GitHub a  stránky a  automaticky aktualizuje pitch deck podle nových informací. Žádné Ctrl+C / Ctrl+V, žádné dohánění změn - vždy máme čerstvou verzi připravenou pro investory, Zadarmo
Je to jako mít virtuálního zaměstnance, který hlídá agendu a  pravidelně ji plní. Místo toho, abychom byli operátoři AI, dáváme agentovi zodpovědnost, aby dělal rutinní práci za nás.
Chcete vědět, jak to technicky funguje? Napište a  rád to vysvětlím.
```
...
Project	About
⭐ Agents Server	The primary way to use Promptbook. A production-ready platform where your AI agents live — create, manage, deploy, and interact with persistent agents that work on goals. Available as a hosted service or self-hosted via Docker.
...
📚 Knowledge (RAG) - Retrieve and use external information
📽 Media handling - Working with images, audio, video, spreadsheets
🔴 Anomaly detection - Identifying unusual patterns or outputs
🌏 Remote server - Executing workflows on remote infrastructure
🃏 Jokers (conditions) - Adding conditional logic to workflows
🔳 Metaprompting - Creating prompts that generate other prompts
Language & Output Control	Advanced Generation
🌏 Linguistically typed languages - Type systems for natural language
🌍 Auto-Translations - Automatic multilingual support
👮 Agent adversary expectations - Safety and control mechanisms
🔙 Expectation-aware generation - Outputs that meet defined criteria
⏳ Just-in-time fine-tuning - Dynamic model adaptation
🔍 View more concepts
