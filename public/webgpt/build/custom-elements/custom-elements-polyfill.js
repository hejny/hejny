            ...
            return (
                l &&
                    e(a).then(function () {
                        ...
                        for (var e = 0, a = l.length; e < a; e++)
                            o.hasAttribute(l[e]) && r({ target: o, attributeName: l[e], oldValue: null });
                    }),
                o
            );
        };
    ...
    /*! (c) Andrea Giammarchi - ISC */ var r = !0,
        ...
        p = function (e) {
            var t = new d(),
                i = function (n, r) {
                    ...
                    if (r)
                        for (
                            ...
                            l.call(n, (a = y[i])) &&
                                (t.has(n) || t.set(n, new f()), (o = t.get(n)).has(a) || (o.add(a), e.handle(n, r, a)));
                    else
                        t.has(n) &&
                            ((o = t.get(n)),
                            t.delete(n),
                ...
                p = function (e) {
                    for (
                        var t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1], n = 0, r = e.length;
                        n < r;
                        n++
                    )
                        i(e[n], t);
                        ...
                        c = function t(o, l, i, c, u, s) {
                            ...
                            try {
                                for (d.s(); !(f = d.n()).done; ) {
                                    ...
                                    (s || a in h) &&
                                        (u
                                            ? i.has(h) || (i.add(h), c.delete(h), e(h, u))
                                            : c.has(h) || (c.add(h), i.delete(h), e(h, u)),
                                        s || t(h[a](l), l, i, c, u, r));
                                }
                            } catch (e) {
                                d.e(e);
                ...
                y.length && p(g[l](y)),
                {
                    ...
                    flush: function () {
                        for (var e = m.takeRecords(), t = 0, n = e.length; t < n; t++)
                            p(v.call(e[t].removedNodes, h), !1), p(v.call(e[t].addedNodes, h), !0);
                    },
                    observer: m,
                    parse: p,
                }
    ...
    if (k) {
        ...
        try {
            ...
            self.customElements.define('extends-br', z, { extends: 'br' }),
                (k = g.createElement('br', { is: G }).outerHTML.indexOf(G) < 0);
        ...
        I(self)
            ...
            (Y.define = function (e, t, n) {
                ...
                ie.set(t, o ? { is: e, tag: o } : { is: '', tag: e }),
                    o
                        ? ((r = ''.concat(o, '[is="').concat(e, '"]')),
                          ue.set(r, t.prototype),
                          se.set(e, t),
                          de.push(r))
                        : (ee.apply(Y, arguments), fe.push((r = e))),
                    ge(e).then(function () {
